...
export function Header({
  ...
  return (
    <header {...props} className={cn("border-b bg-white", className)}>
      ...
      >
        <div data-slot="header-left" className="min-w-0 wrap-anywhere">
          {left}
        </div>
        {center != null && (
          <div
            data-slot="header-center"
            className="col-span-2 row-start-2 min-w-0 text-center wrap-anywhere md:col-span-1 md:col-start-2 md:row-start-1"
          >
            {center}
          </div>
        )}
        <div
          ...
          className={cn(
            "col-start-2 row-start-1 min-w-0 justify-self-end wrap-anywhere",
