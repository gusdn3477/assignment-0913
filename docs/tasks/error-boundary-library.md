...
## 소유권/계약
- 독립 codex/error-boundary-library / .worktrees/error-boundary-library. src/components/candidate/error-boundary/** 및 필요한 실제 소비처(최소화), task/record 소유. package/lock 및 top-level 문서는 통합 담당.
